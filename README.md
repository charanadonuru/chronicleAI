...
Three creativity modes:Conservative
Balanced
Creative
...
The trained model is loaded when the application starts.
The user selects a creativity mode and optionally enters a starting prefix.
The backend generates titles by repeatedly predicting the next character until an end token is reached.
The generated titles are filtered, formatted, and returned to the frontend.
The web interface displays the generated titles along with their confidence scores.
